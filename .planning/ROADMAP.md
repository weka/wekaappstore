...
Plans:
**Wave 1**
- [x] 25-01-PLAN.md — Extract `_get_credentials_by_type(ns)` helper from `settings_page`; wire into `blueprint_detail` with `get_auth_status` namespace resolution; refactor `settings_page` to call the helper (SDK-04, SDK-05)
